...
import MainImage from '../../assets/newSkin/mainImg.svg';
import btn1 from '../../assets/newSkin/m-btn1.svg';
...
export function HomePage() {
  ...
  return (
    <PageContainer className="mainC">
      {auth.isSignedIn ? (
        <Container>
        <Col sm={3} className="main-img"> <a href="/"><img src={MainImage} alt="Main Image" /></a></Col>
        <Col sm={8}></Col>
      ...
      <Container>
        ...
        <Col sm={6}>
          <Row>
            <Col sm={4}>
              <a  href="/link"><img width="100%" src={btn1} alt="verMundos"/></a>
            </Col>
            <Col sm={4}>
            <a href="/"><img width="100%" src={btn2} alt="btn2"/></a>
            </Col>
          </Row>
        </Col>
        <Col sm={8}></Col>
    ...
    //         ) : (
    //           <img alt={configs.translation("app-name")} src={getAppLogo()} className="test" />
    //           // <img alt="Prueba de frander" src={getAppLogo()} className="test" />
    //         )}
    //       </div>

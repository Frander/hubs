...
class UIRoot extends Component {
  ...
  checkForAutoExit = () => {
    console.log("Auto exiting due to " + secondsRemainingBeforeAutoExit);
  ...
  showIframe = (e) => {
    ...
    this.setState({
      dialog: <WebPageUrlModalContainer {...{ onClose: this.closeDialog, scene: this.props.scene, url: e.detail.src, title: "Product" }} />
    });
  };

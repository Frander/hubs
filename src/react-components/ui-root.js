                ...
                toolbarCenter={
                  <>
                    ...
                    {entered && (
                      <>
                        {
                          Object.entries(this.props.presences).map(([id, presence]) => {
                            return userFromPresence(id, presence, getMicrophonePresences(), this.props.sessionId);
                          }).find(person => person.id === this.props.sessionId).roles.owner && <AudioPopoverContainer scene={this.props.scene} />} 
